...
public class QuartzController {
    ...
    public R addJob(@RequestParam("jName") String jName, @RequestParam("jGroup") String jGroup, @RequestParam("tName") String tName,@RequestParam("tGroup")  String tGroup,@RequestParam("cron") String cron,@RequestParam("jobClassName") String jobClassName) {
        try {
            quartzManager.getInstance().addJob(jName, jGroup, tName, tGroup, cron, jobClassName);
