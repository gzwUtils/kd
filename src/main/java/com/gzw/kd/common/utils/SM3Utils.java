...
public class SM3Utils {
  ...
  private static byte[] padding(byte[] source) throws IOException {
    ...
    byteArrayOutputStream.write(long2bytes(l));
   ...
   */
  public static String sm3(String content) throws IOException {
    return SM3Utils.byteArrayToHexString(SM3Utils.hash(content.getBytes()));
  }
}
